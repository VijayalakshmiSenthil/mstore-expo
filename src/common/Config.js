...
//consumerkey and secret is replaced - viji
const consumerKey = 'ck_31b9a349e7535286851a34f78067f2f398294531';
const consumerSecret = 'cs_a8d8bae2806095dc22de734e7f8325f5b684d565';
...
export default {
   ...
   */
  WooCommerce: {
    url: 'https://brassyacademy.com/bestsilver/',
    consumerKey,
    consumerSecret,
  },
  ...
  /**
     ...
     */
  ProductSize: {
    enable: false,//true is modified- viji
  },
  ...
  showStatusBar: true,
  LogoImage: require('@images/mainlogo.png'), //logo image is modidified - viji
  LogoWithText: require('@images/mainlogo.png'),
  LogoLoading: require('@images/mainlogo.png'),
  ...
  intro: [
    {
      key: 'page1',
      image: require('@images/page1.png'),
      title: 'Welcome to BESTSILVER!',
      text: 'In a World of trends Silver remains you classic.',
      //colors: ['#abb8c3','#ffffff','#f78da7'],//colors: ['#0FF0B3', '#036ED9'],
    },
    {
      key: 'page2',
      image: require('@images/page2.png'),
    ...
    {
      key: 'page3',
      image: require('@images/page3.png'),
